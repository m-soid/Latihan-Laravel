...
<div class="p-2 justify-center mb-5">
    <div class="p-4 bg-white border my-auto mx-auto border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            ...
            src="{{ asset('storage/'.$mobil->gambar_mobil) }}" alt="" />

        <div class="p-5">
                <h5 class="mb-2 text-5xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $mobil['nama_mobil'] }}</h5>
            <h5 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          Rp {{ number_format($mobil['harga_mobil'], 0, ',', '.') }}
        </h5>
            <p class="font-normal text-2xl text-gray-700 dark:text-gray-400 text-left"><b>{{ $mobil['tahun_mobil'] }}</b> {{ $mobil['km_mobil'] }}KM</p>
        </div>
        <button type="submit"
