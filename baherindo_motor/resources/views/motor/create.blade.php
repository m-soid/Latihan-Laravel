    ...
    <form action="{{ route('motor.store') }} " method="POST" enctype="multipart/form-data"
     ...
     @csrf
        ...
        <div class="mb-5">
            ...
            <input type="number" name="harga_motor" id="harga_motor" placeholder="Masukan Harga Motor"
        ...
        <div class="mb-5">
            ...
            <input type="number" name="tahun_motor" id="tahun_motor" placeholder="Masukan Tahun Motor"
                class=" border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="mb-5">
            <label for="base-input" class="block mb-2 text-sm font-medium text-gray-800">Jarak
                Tempuh</label>
            <input type="number" name="km_motor" id="km_motor" placeholder="Masukan KM Motor"
                class=" border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <div class="mb-5">
            <label for="base-input" class="block mb-2 text-sm font-medium text-gray-800">Gambar Motor</label>
            <input type="file" name="gambar_motor" id="gambar_motor" placeholder="Masukan KM Motor"
                class=" border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        <button type="submit"
